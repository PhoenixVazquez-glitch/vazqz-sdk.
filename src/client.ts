...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['VAZQZV0_9_1_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['VAZQZV0_9_1_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Vazqzv0 9 1 API.
 */
export class Vazqzv0_9_1 {
  apiKey: string;
   ...
   * @param {string} [opts.baseURL=process.env['VAZQZV0_9_1_BASE_URL'] ?? https://petstore3.swagger.io/api/v3] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('VAZQZV0_9_1_BASE_URL'),
    apiKey = readEnv('PETSTORE_API_KEY'),
    ...opts
  }: ClientOptions = {}) {
    if (apiKey === undefined) {
      throw new Errors.Vazqzv0_9_1Error(
        "The PETSTORE_API_KEY environment variable is missing or empty; either provide it, or instantiate the Vazqzv0_9_1 client with an apiKey option, like new Vazqzv0_9_1({ apiKey: 'My API Key' }).",
      );
    }
    ...
    this.timeout = options.timeout ?? Vazqzv0_9_1.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('VAZQZV0_9_1_LOG'), "process.env['VAZQZV0_9_1_LOG']", this) ??
      defaultLogLevel;
    ...
    const customHeadersEnv = readEnv('VAZQZV0_9_1_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  static Vazqzv0_9_1 = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static Vazqzv0_9_1Error = Errors.Vazqzv0_9_1Error;
...
Vazqzv0_9_1.Pets = Pets;
Vazqzv0_9_1.Store = Store;
Vazqzv0_9_1.Users = Users;

export declare namespace Vazqzv0_9_1 {
